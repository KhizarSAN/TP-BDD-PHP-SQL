...
<html>
	...
	<div class="w3-top">
	 <div class="w3-bar w3-theme-d2 w3-left-align">
	  ...
	  <a href="login.php" class="w3-bar-item w3-button w3-hide-small w3-right w3-hover-teal" >Se connecter</a>
	  <a href="login.php" class="w3-bar-item w3-button w3-hide-small w3-right w3-hover-teal" >S'inscrire</a>
	 </div>

	  <!-- Navbar on small screens -->
	  <div id="navDemo" class="w3-bar-block w3-theme-d2 w3-hide w3-hide-large w3-hide-medium">
		<a href="#team" class="w3-bar-item w3-button">Equipe</a>
		<a href="#work" class="w3-bar-item w3-button">Travail</a> 
		<a href="#contact" class="w3-bar-item w3-button">Contact</a>
		<a href="#" class="w3-bar-item w3-button">Chercher</a>
	...
	<div id="id01" class="w3-modal">
	  <div class="w3-modal-content w3-card-4 w3-animate-top">
		<header class="w3-container w3-teal w3-display-container"> 
		  ...
		  <h4>Lorem</h4>
		  <h5>ipsum <i class="fa fa-smile-o"></i></h5>
		</header>
